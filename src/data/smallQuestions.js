const smallBusinessQuestions = [
  {
    question:
      "Smalllllll Who is the person to attend the Assessment Meeting for This Business. Include all Informaton",
    answer: "",
    placeholder:
...
export default smallBusinessQuestions;
